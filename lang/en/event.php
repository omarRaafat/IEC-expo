...
return [
    ...
    */
    ...
    "guest_title" => "Book now to attend the first women’s auto show.",
    "sponsor_exhibitor_title" => "Be part of the largest auto show for women !",
    "name" => "Full Name",
    "email" => "Email",
    "phone" => "Phone",
    "job" => "Job",
    ...
    "our_message_content" =>"The exhibition offers a diverse selection of cars, introducing visitors to the companies and agents that provide them. It provides valuable insights on selecting the right car based on individual needs and budgets, as well as updates on the latest technologies and advantages offered by cars. Attendees can explore the world of cars, expand their knowledge, and take advantage of exclusive offers and experiences from participating companies and agents. It's an excellent opportunity to enhance knowledge, stay updated on the market, and discover new advancements in automotive technology.",
    "message" => "Message",
    "send" => "Send",
