...
class ClientController extends Controller
{
    ...
    public function SiteEventRegistrationResponse($response)
    {
        ...
        try {
            \Mail::to([$EventRegistration->email])->cc(['expo@umbrella.sa'])->send(new FireMailNotification($EventRegistration) );
            return view('_partials._mail')->with(['data' => $EventRegistration ]);
        } catch (\Throwable $th) {
           return $th;
        }
    }
