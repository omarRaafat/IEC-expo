          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
              ...
              <div class="swiper-slide">
                  <img src="{{asset('assets/assets/img/Projects/44.jpg')}}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/assets/img/Projects/4.jpg')}}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('assets/assets/img/Projects/444.jpg')}}" alt="">
                </div>
