      ...
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center" >
          ...
          <div class="col-lg-10 text-center" style="width:450px;">
            ...
            <div style="backgorund-image:{{asset('/assets/assets/img/Logos/bu_logo_2.png')}}"> <img src="{{asset('/assets/assets/img/Logos/bu_logo_2.png')}}"  style="width:175px;height:155px;background-color:#e1e1e1;border-raduis:50%;border: 1px solid #6b8a3c;" alt="Credit Card" >
    <br><br><hr>
...
<hr>
        <div class="row  justify-content-center" >
          ...
          <div class="visible-print text-center">
			<a href="{{url('/qr/code/scan/'.json_encode($data))}}">Click Me To Scan QR CODE </a>
