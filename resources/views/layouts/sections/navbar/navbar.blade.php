...
<nav class="layout-navbar  navbar navbar-expand-xl container  align-items-center bg-navbar-theme" id="layout-navbar" >
  @endif
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="javascript:void(0);">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <small class="text-muted">{{auth()->user()->user_has_role->name}}</small>
                    </div>
                  </div>
                </a>
              </li>
              ...
              <div class="form-check form-switch">
                                              <input class="form-check-input" type="checkbox" name="badges" value="1" onclick="myFunction()"   id="flexSwitchCheckDefault" >
