...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
     <form id="formAccountSettings" method="POST" action="{{route('dashboard.user.settings')}}" enctype="multipart/form-data">
          @csrf
      <h5 class="card-header">Profile Details</h5>
      <!-- Account -->
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          <img src="{{url(auth()->user()->image)}}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
      ...
      <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="text" id="email" name="password"  placeholder="john.doe@example.com" />
            </div>
            <div class="mb-3 col-md-6">
              <label for="organization" class="form-label">Organization</label>
              <input type="text" class="form-control" id="organization" name="organization" value="Umbrella" disabled />
            </div>
            <!-- <div class="mb-3 col-md-6">
