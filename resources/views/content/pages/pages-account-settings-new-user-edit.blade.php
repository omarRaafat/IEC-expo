...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
     <form id="formAccountSettings" method="POST" action="{{route('pages-account-settings-new-user-edit' , $user->id)}}" enctype="multipart/form-data">
          @csrf
      ...
      <div class="card-body">
        ...
        <form id="formAccountDeactivation" onsubmit="return false">
          <div class="form-check mb-3">
            ...
            <label class="form-check-label" for="accountActivation">I confirm account deactivation</label>
          </div>
