                ...
                @csrf 
                  ...
                  <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge ">
                          ...
                          <input type="text"  name="title_en" value="{{$service->title_en}}"  class="form-control @error('title_en') is-invalid @enderror " id="basic-icon-default-fullname" placeholder="test" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                      ...
                      <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge ">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-text"></i></span>
                              <input type="text"  name="title_ar" value="{{$service->title_ar}}"  class="form-control @error('title_ar') is-invalid @enderror " id="basic-icon-default-fullname" placeholder="test" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description_en') is-invalid @enderror" name="description_en" id="exampleFormControlTextarea1" rows="3"> {{$service->description_en}}</textarea>
                      ...
                      <div class="mb-3">
                          ...
                          <textarea class="form-control @error('description_ar') is-invalid @enderror" name="description_ar" id="exampleFormControlTextarea1" rows="3"> {{$service->description_ar}}</textarea>
                      ...
                      <div class="mb-3">
                          ...
                          <img class="d-block w-100" id="imgPreview_1" style="height:250px" src="{{url($service->image)}}" alt="Service image" />
