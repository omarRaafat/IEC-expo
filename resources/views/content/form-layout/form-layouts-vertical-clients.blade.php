...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Clients/</span> Add New Client</h4>
        ...
        <form action="{{@route('client.add')}}" method="POST">
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge ">
              ...
              <input type="text"  name="name" class="form-control @error('name') is-invalid @enderror " id="basic-icon-default-fullname" placeholder="AHMED EL HARBY" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
...
@enderror
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              ...
              <input type="text" name="website" id="basic-icon-default-company" class="form-control wb" placeholder="UBMRELLA.SA" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
            </div>
          </div>
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              ...
              <input type="text" name="industry" id="basic-icon-default-email" class="form-control @error('industry') is-invalid @enderror" placeholder="ORGANIZATION INDUSTRY" aria-label="john.doe" aria-describedby="basic-icon-default-email2" />
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              <span id="basic-icon-default-address" class="input-group-text"><i class="bx bx-comment"></i></span>
              <input type="text" name="main_telephone" id="basic-icon-default-address2" class="form-control phone-mask  @error('main_telephone') is-invalid @enderror" placeholder="+966000000" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" />
            </div>
...
@enderror
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              <span id="basic-icon-default-address" class="input-group-text"><i class="bx bx-comment"></i></span>
              <input type="text" name="secondry_telephone" id="basic-icon-default-address2" class="form-control phone-mask" placeholder="+966000000" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" />
            </div>
          </div>
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              ...
              <input type="email" name="main_email_address" id="basic-icon-default-email" class="form-control" placeholder="ORGANIZATION INDUSTRY" aria-label="john.doe" aria-describedby="basic-icon-default-email2" />
                      <span id="basic-icon-default-email2" class="input-group-text">@example.com</span>
...
<br><br>
          <input type="submit" onclick="replace_country()" class="btn btn-primary btn-block" value="Request New"/> 
        </form>
      </div>
    </div>
  </div>
