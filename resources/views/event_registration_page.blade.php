                      ...
                      <div class="row gy-4 justify-content-center">
                        <div class="col-6 col-md-4 col-lg-3"><div>
                          <a class="d-block text-decoration-none">
                            <img src="http://buco.sa/wp-content/uploads/2022/02/Full-GreyLogo-e1644496293326.png" class="w-100 h-auto">
                          </a>
                        </div>
                      </div>
                    </div> 
      ...
      <div class="modal-body" >
        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          ...
          @endforeach      
              ...
              <div class="form-check mb-2"><input type="checkbox" required="required" value="agree" id="terms-checkbox" > <label for="terms-checkbox" class="form-check-label"><span>{{__('event.accept')}} </span>
    ...
    <div class="site-info bg-dark text-white"><section class="bg-black text-white">
          ...
          <div id="footer-logo-box" class="col-sm-6 col-md-3 text-center text-md-end">
            <img src="https://umbrella.sa/assets/assets/img/Logos/IEC-logo.png" height="65" alt="IEC Management - International E-Commerce Expo"><br></div>
             <div class="col-sm-6 col-md-3 text-center">
              ...
              <a data-toggle="tooltip" class="link-light text-decoration-none" title="{{__('site.wht_icon_title')}}" href="https://api.whatsapp.com/send?phone=+966541164491&text=Hello I have a question about Road Star event" class="" target="_blank" >
      <i class="fa fa-whatsapp my-float"></i>+966541164491   <img style="width:22px" src="{{url('/assets/assets/img/Logos/whatsapp.png')}}" alt="WhatsApp Icon">
        ...
        document.write(new Date().getFullYear())
             ...
             <a href="#" title="IEC Management" class="text-decoration-none text-black">{{$event->name}}</a> 
             | <a href="#" title="Terms and Conditions" class="text-decoration-none text-black">{{__('event.terms_conditions')}}</a>
            </p>
